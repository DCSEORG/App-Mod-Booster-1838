#!/bin/bash
# deploy-with-chat.sh
# Deploys Expense Management infrastructure including GenAI (Azure OpenAI + AI Search)
...
# Chat UI will use real Azure OpenAI responses
...
echo "============================================"
echo "  Expense Management Deployment (with Chat)"
echo "============================================"
...
# ─── 2. Deploy Infrastructure (App Service + SQL + GenAI) ────────────────────
echo ""
echo "Step 2: Deploying infrastructure (App Service + Azure SQL + GenAI)..."
...
# ─── 3. Configure App Service Settings (including GenAI) ───────────────────────
echo ""
...
echo ""
echo "============================================"
echo "  ✓ Deployment Complete (with Chat)!"
echo "============================================"
echo ""
